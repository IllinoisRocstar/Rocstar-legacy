...
! ******************************************************************************
!
! $Id: RFLO_ModMoveGridNconform1.F90,v 1.39 2008/12/06 08:44:17 mtcampbe Exp $
!
...
! ******************************************************************************  
  ...
  CHARACTER(CHRLEN) :: RCSIdentString = & 
    '$RCSfile: RFLO_ModMoveGridNconform1.F90,v $ $Revision: 1.39 $'        
        ...
        IF (ipEdge==1) THEN
          ...
          IF ((((intb/=0 .OR. inte/=0) .AND. (interType==EDGE_INTERACT_FULL .AND.&
                region%levels(iLev)%edgeCells(iEdge)%interact .EQV. .true.)) &
                         .OR. &
              (intb==2 .OR. inte==2)) .AND. (iset==0)) THEN
...
!
! $Log: RFLO_ModMoveGridNconform1.F90,v $
! Revision 1.39  2008/12/06 08:44:17  mtcampbe
! Updated license.
!
! Revision 1.38  2008/11/19 22:17:28  mtcampbe
! Added Illinois Open Source License/Copyright
!
! Revision 1.37  2006/03/18 11:02:50  wasistho
! screen printed global skewness and minvol
!
! Revision 1.36  2006/03/05 22:27:47  wasistho
! fixed syntax error
!
! Revision 1.35  2006/03/05 21:52:07  wasistho
! changed computational space coordinates to be based on initial grid
!
! Revision 1.34  2006/02/11 03:53:21  wasistho
! made some routines public
!
! Revision 1.33  2006/01/28 22:52:40  wasistho
! fixed iEdgeGlo
!
! Revision 1.32  2005/11/16 22:52:20  wasistho
! update screen print moveGridFOMS
!
! Revision 1.31  2005/11/01 01:18:12  wasistho
! increased tolerance in frameEdges
!
! Revision 1.30  2005/10/28 07:40:58  wasistho
! modified FORMAT 1000
!
! Revision 1.29  2005/10/28 02:53:11  wasistho
! modified mgFrameEdges
!
! Revision 1.28  2005/10/27 19:19:53  wasistho
! modified screen print
!
! Revision 1.27  2005/10/27 05:57:07  wasistho
! added MoveGridFoms
!
! Revision 1.26  2005/08/18 19:51:22  wasistho
! added user define nPass in mgFrameInterface
!
! Revision 1.25  2005/07/10 21:13:09  wasistho
! global alloc dist in SrchNeighbors and CorrectNeighbors, and added pointer grid in mgFrameMoveCorners
!
! Revision 1.24  2005/06/30 19:10:32  wasistho
! made official last added conditions in mgFrameEdges
!
! Revision 1.23  2005/06/29 08:43:50  wasistho
! changed RestoreExternal and set lTyp=1
!
! Revision 1.22  2005/06/29 04:55:36  wasistho
! modified RFLO_MgFrameInterfaces
!
! Revision 1.21  2005/06/27 19:22:53  wasistho
! only ipass=1 in mgFrameInterfaces
!
! Revision 1.20  2005/06/27 01:00:49  wasistho
! stored tolerance in tol
!
! Revision 1.19  2005/06/27 00:36:46  wasistho
! change tolerance in mgFrameSrchNeighbors from 1.e-20 to 1.e-5*edgeLen
!
! Revision 1.18  2005/06/26 06:25:36  wasistho
! nReg==72 to nReg==71
!
! Revision 1.17  2005/06/26 06:11:52  wasistho
! adding more reegions for titan check in mgFrameSrchCorners
!
! Revision 1.16  2005/06/26 05:39:38  wasistho
! bugs fixed in mgFrameCornPoints and mgFrameSrchNeighbors
!
! Revision 1.15  2005/06/25 08:12:23  wasistho
! bug fixed in receiving rvar in mgFrameBCast
!
! Revision 1.14  2005/06/25 06:16:12  wasistho
! swap ENDDO and ENDIF in mgframeBroadCast
!
! Revision 1.13  2005/06/25 03:14:02  wasistho
