 ...
 *********************************************************************/
// $Id: neu2hdf.C,v 1.4 2008/12/06 08:43:24 mtcampbe Exp $
// Converting a .neu file to .hdf.
...
int main(int argc, char *argv[]) {
  ...
  if ( argc < 2) {
    cout << "Usage: " << argv[0] << " <neu_file> [hdf_name] " << endl;
    return -1;
  }
  ...
  Neutral_Reader().read_mesh( argv[1], wname);
