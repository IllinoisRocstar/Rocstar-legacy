...
set InputDir=HTFSI3
set Outputs=HTFSI3_4/probe_proc_2_nde_4.dat
set OutputsCheck=HTFSI3/ref.dat
set TestName=HTFSI3RegressionTest
...
setenv PATH ${3}:${PATH}
$3/rocprep -A -n 4 -f 4 5 -foam 1 1 -d ./HTFSI3/ -t ./HTFSI3_4
cd ./HTFSI3_4
