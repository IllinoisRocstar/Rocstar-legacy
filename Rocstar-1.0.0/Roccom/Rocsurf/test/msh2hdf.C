 ...
 *********************************************************************/
// $Id: msh2hdf.C,v 1.3 2008/12/06 08:43:24 mtcampbe Exp $
// Converting a .msh file to .hdf.
...
int main(int argc, char *argv[]) {
  ...
  if ( argc < 2) {
    cout << "Usage: " << argv[0] << " <msh_file> [hdf_name] " << endl;
    return -1;
  }
  ...
  MSH_Reader().read_mesh( argv[1], wname);
